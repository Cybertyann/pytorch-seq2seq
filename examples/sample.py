...
if opt.load_checkpoint is not None:
    ...
    src.vocab.load_vectors(wv_type='glove.6B', wv_dim=100)
    ...
    if not opt.resume:
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer.optimizer, 'min')
        optimizer.set_scheduler(scheduler)

    # train
    t = SupervisedTrainer(loss=loss, batch_size=32, random_seed=2,
